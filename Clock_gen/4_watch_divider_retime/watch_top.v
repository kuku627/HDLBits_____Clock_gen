...
reg [17-1:0] sec_val_ff; // for sync timing
reg [11-1:0] min_val_div;
reg [5-1:0]  hour_val_div;

	always @(posedge clk) begin
		sec_val_ff <= r_sec_cnt;
		min_val_div <= (r_sec_cnt/60);
		hour_val_div <= (r_sec_cnt/(60*60));
	end

wire [6-1:0] sec_val = sec_val_ff % 60;
wire [6-1:0] min_val = min_val_div % 60;
wire [5-1:0] hour_val = hour_val_div % 24;
